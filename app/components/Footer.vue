  ...
  <footer class="bg-gray-900 text-gray-300">
    <div class="container-custom py-16">
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        <!-- Brand -->
        <div class="space-y-4">
          <Image src="/isologo_sumando.png" alt="Fundación Sumando" class="h-12 w-auto brightness-0 invert" />
          <p class="text-sm text-gray-400">
            Transformando vidas a través de la educación y el desarrollo comunitario desde 2010.
          </p>
          <div class="flex gap-4">
            <a href="#"
              class="w-10 h-10 rounded-full bg-gray-800 hover:bg-primary-600 flex items-center justify-center transition-colors">
        ...
        <div>
          ...
          <ul class="space-y-3">
            ...
            <li><a href="#equipo" class="text-sm hover:text-blue-400 transition-colors">Nuestro Equipo</a></li>
        ...
        <div>
          ...
          <ul class="space-y-3">
            ...
            <li class="flex items-start gap-2">
              ...
              <span class="text-sm">+56 2 1234 5678</span>
            </li>
          </ul>
        </div>
      </div>
